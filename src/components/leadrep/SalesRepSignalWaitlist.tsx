...
export function SalesRepSignalWaitlist({ source = "repwatchr" }: { source?: string }) {
  ...
  return (
    <form onSubmit={submit} className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <p className="text-xs font-black uppercase tracking-[0.18em] text-red-700">Opt-in pilot</p>
      <h2 className="mt-2 text-2xl font-black text-blue-950">Join the Sales Rep Signal pilot.</h2>
