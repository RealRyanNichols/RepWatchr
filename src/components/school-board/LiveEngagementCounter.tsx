    ...
    <div className="rounded-2xl border border-blue-100 bg-white p-5 shadow-xl shadow-blue-100/70">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-xs font-semibold text-gray-500">
            Pulls Supabase vote totals, grade summaries, comments, and latest activity every 30 seconds when the tables are configured.
          </p>
        </div>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
        ...
        >
          ...
          <p className="mt-1 text-xs font-bold uppercase tracking-wide text-gray-500">Vote rows counted</p>
      ...
      <div className="mt-4 grid grid-cols-1 gap-2 rounded-xl border border-gray-100 bg-gray-50 p-3 text-xs font-semibold text-gray-600 sm:grid-cols-2">
        <div>
          Last vote row: <span className="font-bold text-gray-900">{formatRelative(data.lastVoteAt)}</span>
        </div>
        <div>
