...
export const metadata: Metadata = {
  ...
  description:
    "Local accountability reporting for Texas House District 7 and TX-01. Source-backed coverage of officials, school boards, county government, votes, funding, and the public records behind them.",
  keywords: [
    "RepWatchr",
    "East Texas news",
