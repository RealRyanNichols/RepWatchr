    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        ...
        <p className="mt-3 text-sm font-semibold leading-6 text-slate-600">
          Verification checks are linked to your account. Signing in alone does not verify your identity, residence, or uniqueness.
        </p>
        <Link
          href="/auth/login"
    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8">
          ...
          <h1 className="mt-2 text-2xl font-black text-emerald-950">Your residence check is current</h1>
    ...
    <div className="mx-auto max-w-2xl px-4 py-16">
      <div className="rounded-2xl border border-amber-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm font-semibold leading-6 text-slate-700">
          Verified-resident participation is not active while the old self-certification flow is replaced. The separate Marion County pulse accepts signed-in account responses without claiming verified residence. The planned pilot separates identity-provider checks, residence confirmation, and an accessible manual review. RepWatchr will not ask you to type a driver-license or state-ID number into this page.
        </p>

        <div className="mt-6 rounded-xl border border-blue-200 bg-blue-50 p-4">
          <h2 className="text-sm font-black text-blue-950">Separate assurance checks</h2>
          <ul className="mt-2 space-y-2 text-sm font-semibold leading-6 text-blue-900">
            ...
            <li><strong>Paid account, if offered:</strong> an account payment was confirmed; payment does not prove identity or residence.</li>
        ...
        <p className="mt-5 text-sm font-semibold leading-6 text-slate-600">
          No ID image, selfie, raw document number, birth date, or plaintext street address belongs in the RepWatchr database. Camera-free and manual-review paths will receive the same participation privileges. You can still use the dashboard, watch profiles, submit primary sources, and report corrections.
        </p>
