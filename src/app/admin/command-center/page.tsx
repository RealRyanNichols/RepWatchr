...
const actions = [
  ...
  { step: "02", title: "Publish something useful", body: "Use the short daily session for one verified local development. Put the consequence and source in the headline and article.", metric: "Measure: new articles, article opens and search clicks", href: "/admin/content-review", label: "Open editorial desk" },
